...
class RemoteBrowserBasedIntTest extends BaseControllerIntegrationTest {
    ...
    void test_quick_tour() {
        try {
            ...
            Dimension dimension = new Dimension(1095, 1237);// device size
