...
class PortfolioControllerTest {
    ...
    void testGetPortfolioItems() {
        ...
        assertThat(response.getBody().get(0), hasEntry("link", "https://github.com/conorheffron/ironoc-db"));
        assertThat(response.getBody().get(0), hasEntry("description", "Sample Data Manager Service with UI"));
