        ...
        <div className="App">
          ...
          <header className="App-header">
            <div className="App-intro">
              ...
              <a class="btn btn-info" role="button" href="https://linktr.ee/conorheffron" target="_blank" rel="noreferrer">Link Tree</a>
              <br/> <br/>
              <a href="https://www.linkedin.com/in/conorheffron" target="_blank" rel="noreferrer">
               ...
               <br/> <br/>
               <iframe height='160' width='300' frameborder='0' allowtransparency='true' scrolling='no' title='strava-badge'
